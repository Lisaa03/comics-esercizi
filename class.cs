...
//    public void FaiVerso()
//    {
//        Console.WriteLine("bau bau! (Suono del cane)");
//        Console.WriteLine($"Nome: {Fido}");
//    }
//}
...
//    public void FaiVerso()
//    {
//        Console.WriteLine("miao miao! (Suono del gatto)");
//        Console.WriteLine($"Nome: {Whiskers}");
//    }
//}
...
//    Animale animale1 = new Cane()
//   {
//    cane.FaiVerso(); // Stampa: bau bau! (Suono del cane)
//    nome : Fido
//    Animale animale2 = new Gatto();
//    {
//        gatto.FaiVerso(); // Stampa: miao miao! (Suono del gatto)
//        nome: Wiskers
//    }
//}

//Ex04: Gestire una Biblioteca
//Obiettivo:
//Creare una classe Biblioteca che gestisce un elenco di libri.
//Istruzioni:
//Dichiarare la classe Biblioteca con un elenco di oggetti Libro.
//Aggiungere metodi come AggiungiLibro(Libro libro), VisualizzaCatalogo(), e CercaLibro(string titolo).
//Esempio di Utilizzo:

//Biblioteca biblioteca = new Biblioteca();
//Libro libro1 = new Libro { Titolo = "Harry Potter", Autore = "J.K. Rowling", AnnoPubblicazione = 1997 };
//Libro libro2 = new Libro { Titolo = "1984", Autore = "George Orwell", AnnoPubblicazione = 1949 };
//biblioteca.AggiungiLibro(libro1);
//biblioteca.AggiungiLibro(libro2);
//biblioteca.VisualizzaCatalogo();
//// Dovrebbe stampare le informazioni su entrambi i libri
//Libro libroTrovato = biblioteca.CercaLibro("Harry Potter");
//// Dovrebbe restituire l'oggetto Libro corrispondente o null se non trovato
...
class Biblioteca
{
    ...
    {
        if (elencoLibri.Count == 0)
        {
            Console.WriteLine("La biblioteca è vuota.");
            return;
        }

        Console.WriteLine("Catalogo della biblioteca:");
    ...
    {
        return elencoLibri.Find(libro => libro.Titolo.Equals(titolo, StringComparison.OrdinalIgnoreCase));
    }
}
...
class Program
{
    static void Main()
    {
        ...
        biblioteca.AggiungiLibro(new Libro("harry potter", "J.K. Rowling", 1997));
        ...
        Console.WriteLine("\nRicerca di un libro:");
        string titoloDaCercare = "1984";
        Libro libroTrovato = biblioteca.CercaLibro(titoloDaCercare);
        ...
        {
            Console.WriteLine($"Nessun libro trovato con il titolo '{titoloDaCercare}'.");
        }
    }
}